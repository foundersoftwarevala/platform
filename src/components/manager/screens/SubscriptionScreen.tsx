...
// Payment Methods belongs to Finance Manager, which owns money in this platform.
// The panel lives in src/components/finance and is rendered here; there is one
// implementation, not a copy on each side.
