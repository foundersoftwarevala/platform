/**
 * Hand-written interface text.
 *
 * The `en` block is the source catalogue: every string the interface asks the
 * language provider for, keyed by its English wording. The other blocks are
 * reviewed translations and are deliberately incomplete - a missing entry is
 * resolved through the fallback chain, translation memory and the translation
 * service, never invented here.
 *
 * Keys are canonical registry codes (src/lib/i18n/registry.ts). This object was
 * previously `TRANSLATIONS` in src/lib/language-catalog.ts, keyed by the old
 * uppercase codes; that module re-exports it under the same name.
 */
export const UI_DICTIONARY: Record<string, Record<string, string>> = {
  en: {
    ...
    "Factory • Warehouse • Supply Chain • Production":
      "Factory • Warehouse • Supply Chain • Production",
    ...
    "Real Estate • Society • Facility • Service Management":
      "Real Estate • Society • Facility • Service Management",
    ...
    "AI Zone": "AI Zone",
    "Automation copilots built into the marketplace":
      "Automation copilots built into the marketplace",
    "Open tool": "Open tool",
    ...
    "Execution recorded locally — persistence unavailable":
      "Execution recorded locally — persistence unavailable",
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "Team hours 9:00–21:00 IST · replies within 2 hours.",
    "Loading…": "Loading…",
    ...
    "Connect with the Software Vala support team directly:":
      "Connect with the Software Vala support team directly:",
    ...
    "Lifetime access on all 12,000+ products — flat $249 each!":
      "Lifetime access on all 12,000+ products — flat $249 each!",
    ...
    "Every apply option opens a dedicated application page. Each role has a separate form, different fields, a different approval workflow, fee structure, agreement and dashboard access.":
      "Every apply option opens a dedicated application page. Each role has a separate form, different fields, a different approval workflow, fee structure, agreement and dashboard access.",
    ...
    "Role-specific workspace module from the source dashboard structure.":
      "Role-specific workspace module from the source dashboard structure.",
    "This route now renders the real dashboard view for the selected role and preserves the existing Control Panel navigation flow.":
      "This route now renders the real dashboard view for the selected role and preserves the existing Control Panel navigation flow.",
    ...
    "That role does not exist. Pick one of the available applications.":
      "That role does not exist. Pick one of the available applications.",
    ...
    "Application submitted — sent to the boss panel for approval.":
      "Application submitted — sent to the boss panel for approval.",
    "Application submitted": "Application submitted",
    "Your {role} application is now pending approval. The admin team has been notified and you will receive an update on {email}.":
      "Your {role} application is now pending approval. The admin team has been notified and you will receive an update on {email}.",
    ...
    Previous: "Previous",
    Next: "Next",
    // Source strings requested by the interface that the catalogue did not list.
    "Enter your email and password to continue.": "Enter your email and password to continue.",
    "Loading your influencer workspace...": "Loading your influencer workspace...",
    "Influencer Dashboard": "Influencer Dashboard",
    "Profile country pending": "Profile country pending",
    "Approved profile": "Approved profile",
    "Social accounts": "Social accounts",
    "Assigned campaigns": "Assigned campaigns",
    "Verified activities": "Verified activities",
    "Payable earnings": "Payable earnings",
    Campaigns: "Campaigns",
    "Campaign brief": "Campaign brief",
    "No campaigns assigned yet.": "No campaigns assigned yet.",
    Activity: "Activity",
    "No activity recorded yet.": "No activity recorded yet.",
    Earnings: "Earnings",
    "No earnings yet.": "No earnings yet.",
    "Invoices & payouts": "Invoices & payouts",
    Payout: "Payout",
    "No invoices or payouts yet.": "No invoices or payouts yet.",
    "No notifications yet.": "No notifications yet.",
    "Create a Campaign": "Create a Campaign",
    "Review Applications": "Review Applications",
    "Sign in to load live data": "Sign in to load live data",
    "Live records": "Live records",
    "No live session": "No live session",
    "Connected source": "Connected source",
    "Supabase marketing data": "Supabase marketing data",
    "Authentication required": "Authentication required",
    Updated: "Updated",
    "Sign in with an authorized manager account to access creator records.":
      "Sign in with an authorized manager account to access creator records.",
    Login: "Login",
    Dashboards: "Dashboards",
    "Role dashboards": "Role dashboards",
    Dashboard: "Dashboard",
    "your marketplace": "your marketplace",
    "new alerts": "new alerts",
    "All caught up": "All caught up",
    Insights: "Insights",
    "Marketplace Manager": "Marketplace Manager",
    "Marketplace CMS": "Marketplace CMS",
    "Software Vala · Boss Console": "Software Vala · Boss Console",
    "Ask Vala AI": "Ask Vala AI",
    Boss: "Boss",
    "Boss Operator": "Boss Operator",
    Profile: "Profile",
    Settings: "Settings",
    "API keys": "API keys",
    "Jump to a section, page, or setting…": "Jump to a section, page, or setting…",
    "No matching sections.": "No matching sections.",
    "Active Projects": "Active Projects",
    "Track runtime project health, stack, and deployment visibility.":
      "Track runtime project health, stack, and deployment visibility.",
    Projects: "Projects",
    Active: "Active",
    Build: "Build",
    "No active project records available.": "No active project records available.",
    "Unknown stack": "Unknown stack",
    URL: "URL",
    "Last deploy": "Last deploy",
    Credits: "Credits",
    "Usage, balance and top-up pressure signals.": "Usage, balance and top-up pressure signals.",
    Balance: "Balance",
    "Today usage": "Today usage",
    "Month usage": "Month usage",
    Runway: "Runway",
    "No credit transactions available.": "No credit transactions available.",
    Critical: "Critical",
    Warning: "Warning",
    Success: "Success",
    "Error Detection": "Error Detection",
    "Continuous scan for broken routes, APIs and permission gaps.":
      "Continuous scan for broken routes, APIs and permission gaps.",
    "Open issues": "Open issues",
    "Clean checks": "Clean checks",
    "No diagnostics recorded.": "No diagnostics recorded.",
    "No anomalies detected in latest scan.": "No anomalies detected in latest scan.",
    "Every command executed against the platform, with latency and outcome.":
      "Every command executed against the platform, with latency and outcome.",
    Total: "Total",
    Warnings: "Warnings",
    "Avg latency": "Avg latency",
    "No execution logs available.": "No execution logs available.",
    "No project": "No project",
    "Lock Status": "Lock Status",
    "Inspect and change VALA AI write lock state.": "Inspect and change VALA AI write lock state.",
    "System Lock": "System Lock",
    "No reason": "No reason",
    Disabled: "Disabled",
    "Lock armed": "Lock armed",
    Unlock: "Unlock",
    "Changed by": "Changed by",
    system: "system",
    "AI Models": "AI Models",
    "Routing pool used by the VALA AI command engine.":
      "Routing pool used by the VALA AI command engine.",
    Models: "Models",
    "Requests (30d)": "Requests (30d)",
    "Avg. latency": "Avg. latency",
    "No models registered.": "No models registered.",
    Requests: "Requests",
    Latency: "Latency",
    Load: "Load",
    "Search prompts, projects or languages": "Search prompts, projects or languages",
    "Search prompt history": "Search prompt history",
    "No prompts match this search.": "No prompts match this search.",
    "Rollback Trigger": "Rollback Trigger",
    "Approve a previous stable snapshot before restoring it.":
      "Approve a previous stable snapshot before restoring it.",
    "No snapshots recorded.": "No snapshots recorded.",
    "Platform-wide": "Platform-wide",
    Rollback: "Rollback",
    "Confirm rollback": "Confirm rollback",
    'This restores the platform to "{label}". All changes made after this snapshot will be reverted.':
      'This restores the platform to "{label}". All changes made after this snapshot will be reverted.',
    "Boss approval required for rollback execution":
      "Boss approval required for rollback execution",
    "Request Boss Approval": "Request Boss Approval",
    "Module Settings": "Module Settings",
    "Governed VALA AI platform configuration.": "Governed VALA AI platform configuration.",
    "No settings rows found.": "No settings rows found.",
    "No description": "No description",
    "Live PostgreSQL": "Live PostgreSQL",
    "Seed dataset": "Seed dataset",
    "VALA AI COMMAND CENTER INITIALIZED": "VALA AI COMMAND CENTER INITIALIZED",
    LOCKED: "LOCKED",
    UNLOCKED: "UNLOCKED",
    "Vala AI Management": "Vala AI Management",
    "The Vala AI management workspace is now integrated into the Control Panel. Use this module to access the AI command center, analytics, execution logs, prompt history, and platform-wide AI controls.":
      "The Vala AI management workspace is now integrated into the Control Panel. Use this module to access the AI command center, analytics, execution logs, prompt history, and platform-wide AI controls.",
    "Command Center": "Command Center",
    "Run structured platform commands and issue AI-powered tasks from the central Vala workspace.":
      "Run structured platform commands and issue AI-powered tasks from the central Vala workspace.",
    "AI Activity": "AI Activity",
    "Track history, logs, project state, and model usage while AI operations execute.":
      "Track history, logs, project state, and model usage while AI operations execute.",
    "In-app AI Assistant": "In-app AI Assistant",
    "The floating Vala AI assistant is also available here for immediate conversational support.":
      "The floating Vala AI assistant is also available here for immediate conversational support.",
    "Close menu overlay": "Close menu overlay",
  ...
  hi: {
    ...
    "Real Estate • Society • Facility • Service Management":
      "रियल एस्टेट • सोसाइटी • सुविधा • सेवा प्रबंधन",
    ...
    "Streaming purchases, downloads, reviews & releases":
      "स्ट्रीमिंग खरीदारी, डाउनलोड, समीक्षा और रिलीज",
    "Frequently Asked Questions": "अक्सर पूछे जाने वाले प्रश्न",
    "Everything about pricing, delivery, white label and support":
      "मूल्य, डिलीवरी, व्हाइट लेबल और सहायता से जुड़ी सब कुछ",
    ...
    "Ask about products, pricing, demos or partner programs.":
      "उत्पादों, मूल्य निर्धारण, डेमो या भागीदार कार्यक्रमों के बारे में पूछें।",
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "टीम समय 9:00–21:00 IST · 2 घंटे के भीतर जवाब।",
  ...
  es: {
    ...
    "Ask about products, pricing, demos or partner programs.":
      "Pregunta sobre productos, precios, demostraciones o programas de socios.",
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "Horario del equipo 9:00–21:00 IST · respuestas en 2 horas.",
    "Loading…": "Cargando…",
  ...
  fr: {
    ...
    "Ask about products, pricing, demos or partner programs.":
      "Demandez des produits, des prix, des démos ou des programmes partenaires.",
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "Heures de l'équipe 9:00–21:00 IST · réponses sous 2 heures.",
    "Loading…": "Chargement…",
  ...
  de: {
    ...
    "Ask about products, pricing, demos or partner programs.":
      "Fragen Sie nach Produkten, Preisen, Demos oder Partnerprogrammen.",
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "Teamzeiten 9:00–21:00 IST · Antworten innerhalb von 2 Stunden.",
  ...
  ar: {
    ...
    "Ask about products, pricing, demos or partner programs.":
      "اسأل عن المنتجات أو الأسعار أو العروض التوضيحية أو برامج الشركاء.",
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "ساعات الفريق 9:00–21:00 IST · الرد خلال ساعتين.",
  ...
  ko: {
    ...
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "팀 운영시간 9:00–21:00 IST · 2시간 내 응답",
    Calendar: "캘린더",
    ...
    "Ask about products, pricing, demos or partner programs.":
      "제품, 가격, 데모 또는 파트너 프로그램에 대해 문의하세요.",
  ...
  ja: {
    ...
    "Connect with the Software Vala support team directly:":
      "Software Vala サポートチームに直接接続:",
    "WhatsApp live chat": "WhatsApp ライブチャット",
    "Email support": "メールサポート",
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "チーム対応時間 9:00–21:00 IST · 2時間以内に返信",
    Calendar: "カレンダー",
    ...
    "Ask about products, pricing, demos or partner programs.":
      "製品、価格、デモ、パートナープログラムについてお問い合わせください。",
  ...
  pt: {
    ...
    "Location permission denied — search a city instead.":
      "Permissão de localização negada — pesquise uma cidade em vez disso.",
    ...
    "Connect with the Software Vala support team directly:":
      "Conecte-se diretamente com a equipe de suporte Software Vala:",
    "WhatsApp live chat": "Chat ao vivo no WhatsApp",
    "Email support": "Suporte por e-mail",
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "Horário da equipe 9:00–21:00 IST · respostas em até 2 horas.",
    Calendar: "Calendário",
    ...
    "Ask about products, pricing, demos or partner programs.":
      "Pergunte sobre produtos, preços, demonstrações ou programas de parceiros.",
    ...
    "Something went wrong on our end. You can try refreshing or head back home.":
      "Algo deu errado do nosso lado. Tente atualizar ou volte para a página inicial.",
  ...
  bn: {
    ...
    "Location permission denied — search a city instead.":
      "অবস্থান অনুমতি অস্বীকৃত — পরিবর্তে একটি শহর সন্ধান করুন।",
    ...
    "Connect with the Software Vala support team directly:":
      "Software Vala সমর্থন দলের সাথে সরাসরি সংযোগ করুন:",
    "WhatsApp live chat": "WhatsApp লাইভ চ্যাট",
    "Email support": "ইমেল সমর্থন",
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "টিম সময় 9:00–21:00 IST · 2 ঘণ্টার মধ্যে উত্তর",
    ...
    "Ask about products, pricing, demos or partner programs.":
      "পণ্য, মূল্য, ডেমো বা পার্টনার প্রোগ্রামের বিষয়ে জিজ্ঞাসা করুন।",
    ...
    "Something went wrong on our end. You can try refreshing or head back home.":
      "আমাদের পক্ষ থেকে কিছু ভুল হয়েছে। আপনি রিফ্রেশ করে দেখতে পারেন বা হোমে ফিরে যেতে পারেন।",
  ...
  ur: {
    ...
    "Location permission denied — search a city instead.":
      "مقام کی اجازت مسترد کر دی گئی — اس کے بجائے کوئی شہر تلاش کریں۔",
    ...
    "Connect with the Software Vala support team directly:":
      "Software Vala سپورٹ ٹیم سے براہ راست رابطہ کریں:",
    "WhatsApp live chat": "WhatsApp لائیو چیٹ",
    "Email support": "ای میل سپورٹ",
    "Team hours 9:00–21:00 IST · replies within 2 hours.":
      "ٹیم کے اوقات 9:00–21:00 IST · 2 گھنٹوں میں جواب",
    Calendar: "کیلنڈر",
    ...
    "Ask about products, pricing, demos or partner programs.":
      "مصنوعات، قیمتوں، ڈیمو یا پارٹنر پروگرام کے بارے میں پوچھیں۔",
    "Type a message…": "ایک پیغام لکھیں…",
    "Thinking…": "سوچ رہا ہے…",
    "Page not found": "صفحہ نہیں ملا",
    "The page you're looking for doesn't exist or has been moved.":
      "جس صفحہ کی آپ تلاش کر رہے ہیں وہ موجود نہیں یا منتقل ہو چکا ہے۔",
    "Go home": "گھر جائیں",
    "This page didn't load": "یہ صفحہ لوڈ نہیں ہوا",
    "Something went wrong on our end. You can try refreshing or head back home.":
      "ہماری طرف سے کچھ غلط ہو گیا ہے۔ آپ ریفریش کریں یا گھر واپس جائیں۔",
